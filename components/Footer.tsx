      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#inicio"
                  className="text-white/60 hover:text-node-blue transition-colors"
                >
                  Inicio
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white/60">contacto@nodesolutions.es</li>
              <li className="text-white/60">+34 600 000 000</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <a
                href="#"
                className="text-white/40 hover:text-node-blue transition-colors"
              >
                Privacidad
              </a>
              <a
